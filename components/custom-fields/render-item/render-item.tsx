...
const RenderItem = ({ item, drag, isActive, handleDelete, schema, navigation }) => {
  return (
    <TouchableOpacity style={styles.itemContainer} onLongPress={drag}>
      ...
      <View style={styles.itemActions}>
        <ButtonIcon text="Edit" type="primary" icon="Magicpen" action={() => navigation.navigate("CustomFieldPost", { item: item, schema })} />
